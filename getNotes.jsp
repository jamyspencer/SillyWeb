      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
               <li class="active"><a href="http://hoare.cs.umsl.edu/servlet/j-spencer/sessionServlet">Link <span class="sr-only">(current)</span></a></li>
               <li><a href="http://hoare.cs.umsl.edu/servlet/j-spencer/sessionServlet?logout='true'">Logout</a></li>
            </ul>
